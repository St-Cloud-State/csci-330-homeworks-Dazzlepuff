#ifndef CSVTOLENGTHINDICATED_H
#define CSVTOLENGTHINDICATED_H
...
void writeStructuredFile(const std::string& csvFile, const std::string& outputFile);

#endif // CSVTOLENGTHINDICATED_H
